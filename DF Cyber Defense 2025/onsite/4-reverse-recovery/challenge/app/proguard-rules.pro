...
# Ensure NativeCrypto JNI methods are not removed or renamed (RegisterNatives requires exact names)
-keepclasseswithmembers class com.example.pixelblackout.nativebridge.NativeCrypto {
    native <methods>;
}
...
# Keep method name for JNI bridge invoked via reflection in native
-keepclassmembers class com.example.pixelblackout.managers.CommandDispatcher {
    public java.lang.String executeForNative(java.lang.String, java.lang.String);
}

# Prevent R8/ProGuard from obfuscating ListenableFuture field names used by
# AtomicReferenceFieldUpdater in AndroidX (to avoid "SafeAtomicHelper is broken!")
...
-keepclassmembers class androidx.work.impl.utils.futures.AbstractFuture {
    volatile java.lang.Object value;
...
# As an extra safety net, keep the entire futures classes and their nested types.
...
# Avoid repackaging AndroidX (safer for reflection-based utilities)
